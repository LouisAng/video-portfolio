              ...
              <div>
                ...
                <div className="bg-gray-50 p-8 rounded-lg">
                  ...
                  <div className="flex space-x-4">
                    ...
                    <a href="https://www.youtube.com/channel/UCTkGvVpwKVntCpygYgDnwCg" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-primary-600 transition">
